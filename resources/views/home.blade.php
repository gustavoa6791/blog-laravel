...
@section('content')
<div class="bg-gray-900 px-20 py-2 rounded-lg mb-8 relative overflow-hidden">
    <span class="text-xs uppercase text-gray-700 bg-gray-400 rounded-full px-2 py-1">Programación</span> 
    <h1 class="text-3xl text-white ">Blog</h1>
    <p class="text-sm text-gray-400 mt-2">Proyecto de desarrollo web para profesionales</p>
    <img src="{{ Vite::asset('resources/images/dev.png') }}" width="100" class="absolute top-0 right-0 opacity-20">
</div>

<div class="px-4">
    <h1 class="text-2xl mb-8 text-gray-900">Listado de Publicaciones Recientes</h1>
